 ...
 * 原始路径：Assets\NOT_Lonely\FirstPersonController\SimpleFPController.cs
 * 分类/优先级：样例交互 / C-扩展
 * 文件职责：样例第一人称移动、相机动画和脚步反馈。
 * 数据流位置：输入/Animator/PhysicsMaterial -> 玩家反馈。
 * 主要 Unity 技术：CharacterController、Input、Animator、Raycast
 * 建议关注：真正压痕来自 layer 23 的鞋底 DepthOccluder 网格。
