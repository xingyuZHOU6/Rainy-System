 ...
 * 原始路径：Assets\NOT_Lonely\Weatherade SRS\Shaders\Editor\NL_SRS_SnowCoverageTerrain_GUI.cs
...
namespace NOT_Lonely.Weatherade.ShaderGUI
{
    ...
    public class NL_SRS_SnowCoverageTerrain_GUI : UnityEditor.ShaderGUI, ITerrainLayerCustomUI
    {
        ...
        public NL_SRS_SnowCoverageTerrain_GUI()
        {
        }
        ...
        public override void OnGUI(MaterialEditor materialEditorIn, MaterialProperty[] properties)
        {
            ...
            snowCoverageGUI.DrawCoverageGUI(materialEditorIn);
            //
