...
// 原始路径：Assets\NOT_Lonely\Weatherade SRS\Shaders\Includes\SRS_LitDepthNormalsPass.hlsl
// 分类/优先级：URP 多 Pass / B-支持
// 文件职责：输出位移后且带雪/痕迹影响的深度法线。
// 数据流位置：雪法线/位移 -> DepthNormals。
// 主要 Unity 技术：URP DepthNormals、Oct 编码、Rendering Layers
// 建议关注：保证 SSAO 等依赖深度法线的效果一致。
