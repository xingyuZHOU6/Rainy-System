...
// 原始路径：Assets\NOT_Lonely\Weatherade SRS\Shaders\Includes\SRS_ShadowCasterPass.hlsl
// 分类/优先级：URP 多 Pass / B-支持
// 文件职责：让位移后的雪几何投射正确阴影。
// 数据流位置：Displace -> 灯光裁剪空间 -> Shadow Map。
// 主要 Unity 技术：URP Shadow Bias、ShadowCaster
// 建议关注：确认阴影顶点同样走 Displace。
