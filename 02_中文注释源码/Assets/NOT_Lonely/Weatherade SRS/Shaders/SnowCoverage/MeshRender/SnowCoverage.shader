...
// 原始路径：Assets\NOT_Lonely\Weatherade SRS\Shaders\SnowCoverage\MeshRender\SnowCoverage.shader
// 分类/优先级：Mesh 雪 Shader 入口 / B-支持
// 文件职责：非细分 Mesh 雪 Shader，汇总 Properties、keywords 和 URP 各 Pass。
// 数据流位置：材质 -> Snow HLSL includes -> URP。
// 主要 Unity 技术：ShaderLab、LocalKeyword、多 Pass
// 建议关注：把它当目录读，核心算法在 Includes。
