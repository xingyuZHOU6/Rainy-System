...
// 原始路径：Assets\NOT_Lonely\Weatherade SRS\Shaders\SnowCoverage\TerrainBake\SnowCoverage (Terrain-BaseGen).shader
...
Shader "Hidden/NOT_Lonely/Weatherade/SnowCoverage_TerrainBaseGen"
{
    Properties
    {
        ...
        Pass
        {
            ...
            /*
                ...
                */
                ...
                float4 albedoSmoothness = tex2D(_SRS_BaseMapCustom, i.texcoord0);
